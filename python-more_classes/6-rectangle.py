...
class Rectangle:
    """Class that defines a rectangle and tracks the number of instances
    ...
    def __repr__(self):
        """Returns recreatable string of the rectangle"""
        return "Rectangle({:d}, {:d})".format(self.__width, self.__height)

    def __del__(self):
        """Decrements instance counter and prints a message on deletion"""
